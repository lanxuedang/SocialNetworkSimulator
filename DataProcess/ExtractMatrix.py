...
UserData = ReadData(path + "User_Vaccine_TOP30MA.csv")
UserMADict = {}
        ...
        for rows in reader:
            ...
            for i in range(len(friends)):
                ...
                if friends[i] in UserMADict.keys():
                    weightMatrix[int(UserMADict[friends[i]][1])][int(UserMADict[rows[USER_ID_COLUMN]][1])] += 1
...
with open("C:\\SocialNetworkSimulator\\Tweets\\Vaccine\\WeightMatrix.txt", 'wb') as fileWeightMatrix:
    sequences = []
